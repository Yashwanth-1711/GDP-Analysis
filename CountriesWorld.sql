...
-- Drop the database if it exists (SQL Server 2016+)
IF EXISTS (SELECT * FROM sys.databases WHERE name = 'countries')
BEGIN
...
IF OBJECT_ID('dbo.countries_world', 'U') IS NOT NULL
    DROP TABLE dbo.countries_world;
GO
